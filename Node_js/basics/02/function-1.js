...
// 비동기식 프로그램
function displayA_Asynchronous_A() {
  console.log('A');
}

function displayB_Asynchronous_B() {
  setTimeout(() => {
    console.log('B');
  }, 2000);
  // 2초뒤에 실행
...
function displayC_Asynchronous_C() {
  console.log(`C`);
}

displayA_Asynchronous_A();
displayB_Asynchronous_B();
displayC_Asynchronous_C();