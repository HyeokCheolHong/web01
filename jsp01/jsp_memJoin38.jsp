...
<html lang="ko">
  ...
  <body>
    ...
    <form action="mem_JoinOk.jsp" method="post" onsubmit="return join_check();">
      ...
      <input type="password" name="password" value="" size="14" autocomplete="current-password"/><br/><br/>

      <label for="password02">비밀번호 확인</label>
      <input type="password" name="password02" value="" size="14" autocomplete="new-password"/><br/><br/>

      <label for="name">회원이름</label>
      <input type="text" name="name" value="" size="10"/><br/><br/>

      <label for="phone">휴대폰번호</label>
      <input type="text" name="phone" value="" size="10"/><br/><br/>

      <label for="email">이메일</label>
      <input type="email" name="email" value="" size="20"/><hr/>
